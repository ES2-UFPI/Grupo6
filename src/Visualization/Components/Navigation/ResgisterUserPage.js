		...
		<div className="main">
			...
			<div className="form">
				<div className="name-section">
					...
					<input required type="text" name="username" maxLength={100}></input>
				...
				<div className="cpf-section">
					...
					<input required type="text" name="cpf" maxLength={11}></input>
				...
				<div className="adress-section">
					...
					<div className="rua">
						...
						<input required type="text" name="rua" maxLength={30}></input>
						<span className="missing-rua-span">{}</span>
					</div>
					<div className="numero">
						<label htmlFor="numero">- Número * :</label>
						<input required type="text" name="numero" maxLength={6}></input>
					...
					<div className="cep">
						...
						<input required type="text" name="cep" maxLength={8}></input>
						<span className="missing-cep-span">{}</span>
					</div>
					<div className="cidade">
						<label htmlFor="cidade">- Cidade * :</label>
						<input required type="text" name="cidade" maxLength={30}></input>
